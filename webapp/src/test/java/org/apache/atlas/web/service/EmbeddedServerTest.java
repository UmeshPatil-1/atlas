...
public class EmbeddedServerTest {
    ...
    public void testAuditServerStatusActive() throws Exception {
        ...
        // EmbeddedServer in server-common no longer has auditService or auditServerStatus().
        // Verify basic construction works with ServiceState available.
        assertNotNull(embeddedServer);
    }
    ...
    public void testAuditServerStatusWithException() throws Exception {
        ...
        // EmbeddedServer in server-common no longer has auditService or auditServerStatus().
        // Verify basic construction still works even without audit.
        assertNotNull(embeddedServer);
    }
