...
public class ActiveInstanceStateTest {
    ...
    public void testSharedPathIsCreatedWithRightACLIfNotExists() throws Exception {
        ...
        when(createBuilder.withACL(Arrays.asList(expectedAcl, expectedAcl1))).thenReturn(createBuilder);
    ...
    public void testDataIsUpdatedWithAtlasServerAddress() throws Exception {
        ...
        verify(setDataBuilder).forPath(getPath(), SERVER_ADDRESS.getBytes(StandardCharsets.UTF_8));
    }
    ...
    private String getPath() {
        return HAConfiguration.ATLAS_SERVER_ZK_ROOT_DEFAULT + ActiveInstanceState.APACHE_ATLAS_ACTIVE_SERVER_INFO;
    }
}
