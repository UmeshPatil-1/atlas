    ...
    private void setLdapProperties() {
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("AtlasLdapAuthenticationProvider{ldapURL='{}', ldapUserDNPattern='{}', ldapGroupSearchBase='{}', ldapGroupSearchFilter='{}', ldapGroupRoleAttribute='{}', ldapBindDN='{}', ldapDefaultRole='{}', ldapUserSearchFilter='{}', ldapReferral='{}', ldapBase='{}', groupsFromUGI={}}",
                        ldapURL, ldapUserDNPattern, ldapGroupSearchBase, ldapGroupSearchFilter, ldapGroupRoleAttribute, ldapBindDN, ldapDefaultRole, ldapUserSearchFilter, ldapReferral, ldapBase, groupsFromUGI);
            }
        } catch (Exception e) {
