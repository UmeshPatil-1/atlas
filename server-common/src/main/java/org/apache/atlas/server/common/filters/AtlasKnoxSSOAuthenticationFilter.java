...
public class AtlasKnoxSSOAuthenticationFilter implements Filter {
    ...
    private static final int    MAX_LOGIN_URL_LENGTH = 2043;
    ...
    private Map<String, String> parseXForwardHeader(HttpServletRequest httpRequest) {
        ...
        if (StringUtils.isNotEmpty(xForwardedProto) && StringUtils.isNotEmpty(xForwardedHost) && StringUtils.isNotEmpty(xForwardedContext)) {
    ...
    private String constructForwardableURL(Map<String, String> xFwdHeaderMap, String requestURI) {
        LOG.debug(" constructForwardableURL ==>>{} requestURI {}", xFwdHeaderMap, requestURI);
        ...
        if (xFwdHeaderMap != null) {
            ...
            if (StringUtils.isNotBlank(xForwardedProto) && StringUtils.isNotBlank(xForwardedHost) && StringUtils.isNotBlank(xForwardedContext)) {
                try {
