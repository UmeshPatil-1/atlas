    ...
    private void setADProperties() {
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("AtlasADAuthenticationProvider{adURL='{}', adDomain='{}', adBindDN='{}', adUserSearchFilter='{}', adBase='{}', adReferral='{}', adDefaultRole='{}', groupsFromUGI={}}",
                        adURL, adDomain, adBindDN, adUserSearchFilter, adBase, adReferral, adDefaultRole, groupsFromUGI);
            }
        } catch (Exception e) {
